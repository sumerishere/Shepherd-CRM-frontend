...
const TemplateCreated = ({ username }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Append the formDataRequest as a stringified JSON object
    formDataObject.append(
        ...
        new Blob([JSON.stringify({
            ...
            formData: {
                ...
                "membership plan": formData["membership plan"],
                "fees paid": formData["fees paid"],
                "plan active": formData["plan active"]
            }
        })], { type: "application/json" })
    );

    // Append files if present
    if (formData["adhar card"] instanceof File) {
        formDataObject.append("image", formData["adhar card"]);
    }
